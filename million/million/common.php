...
<?php
	foreach($require_css as $key_css => $value_css){
		echo '	<link rel="stylesheet" type="text/css" href="'.QINIUPATH.'css/'.$value_css.'.css" />'."\r\n";
	}
...
?></style><?php } ?><?php
	foreach($require_js as $key_js => $value_js){
		echo '	<script type="text/javascript" src="'.QINIUPATH.'js/'.$value_js.'.js"></script>'."\r\n";
	}
	...
	<span class="hat">
		...
		<span class="navigation">
			<span class="navitem1">
				...
				<a href="select.htm"><span>加入格子</span></a>
			</span><span class="navitem3">
				<a href="history.htm"><span>成长记录</span></a>
			</span><span class="navitem4">
				<a href="faq.htm"><span>FAQ</span></a>
			</span><span class="navitem5">
				<a href="comments.htm"><span>留言板</span></a>
			</span><span class="navitem6">
				<a href="mglist.htm"><span>管理格子</span></a>
			</span>
		</span>
	</span>
	<span class="body">
		<span class="head">
			...
			<span class="logo">
				<img src="<?php echo QINIUPATH ?>images/logo.png"/>
			</span><span class="headmiddle">
				<span class="summary">
					<span>每个格子价值￥100</span>
					<span class="point"><img src="<?php echo QINIUPATH?>images/point.png"/></span>
		...
		<span class="mailto">如有任何问题，请在留言板留言，或联系我（mail:<a href="mailto:baiwanshouye@163.com">baiwanshouye@163.com</a> / QQ:<a href="tencent://message/?uin=329699920">329699920</a>）</span>
